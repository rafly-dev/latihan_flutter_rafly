...
class Fitur5_2 extends StatefulWidget {
  const Fitur5_2({super.key, required String payload, required info});

  @override
  State<Fitur5_2> createState() => _Fitur5_2State();
}

class _Fitur5_2State extends State<Fitur5_2> {
  @override
  void initState() {
    permission();
    super.initState();
